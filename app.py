...
_TIERS = [
    ...
    },
    {
        "name": "LA PINTE",
        "price": "~30€",
        "price_sub": "A round for the team",
    ...
    },
    {
        ...
        "features": ["Everything in La Pinte", "CSV export", "Excel export", "Priority support", "PRO access"],
        "missing": [],
        "cta": "Feed the team",
        "url": PAYPAL_KEBAB,
        "badge": "Most popular",
    ...
    },
    {
        ...
        "features": ["Everything in Le Kebab", "Fuel for 5 data scientists", "We integrate on your infra", "Weekly strategy call", "Direct access to Victor"],
        "missing": [],
        "cta": "Book the jet",
        "url": PAYPAL_JET,
        "badge": None,
